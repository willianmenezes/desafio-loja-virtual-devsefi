        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Valor = table.Column<decimal>(type: "numeric(18,2)", unicode: false, nullable: false),
                    Quantidade = table.Column<int>(type: "integer", unicode: false, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItensPedido", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pedido_ItemPedido_IdPedido",
                        column: x => x.IdPedido,
